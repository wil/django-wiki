...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('djiki', ['PageRevision'])

        # Adding model 'Image'
        db.create_table('djiki_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
        ))
        db.send_create_signal('djiki', ['Image'])

        # Adding model 'ImageRevision'
        db.create_table('djiki_imagerevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=400, blank=True)),
        ...
        db.send_create_signal('djiki', ['ImageRevision'])


    def backwards(self, orm):
        
        # Deleting model 'Page'
        db.delete_table('djiki_page')

        # Deleting model 'PageRevision'
        db.delete_table('djiki_pagerevision')

        # Deleting model 'Image'
        db.delete_table('djiki_image')

        # Deleting model 'ImageRevision'
        db.delete_table('djiki_imagerevision')
    ...
    models = {
        ...
        'djiki.imagerevision': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'revisions'", 'to': "orm['djiki.Image']"})
        },
        'djiki.page': {
        ...
        'djiki.pagerevision': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '400', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'revisions'", 'to': "orm['djiki.Page']"})
        }
    }
